...
// d3.csv("js-custom/viz/sectorViz/Edu/EduTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Edu/EduTypePieData.php", function(error, data) {
...
// d3.csv("js-custom/viz/sectorViz/Edu/SizeTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Edu/EduSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/Edu/EduAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Edu/EduAgePieData.php", function(error, data) {
