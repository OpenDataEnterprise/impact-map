...
// d3.csv("js-custom/viz/sectorViz/Heal/HealTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Heal/HealTypePieData.php", function(error, data) {
...
d3.json("js-custom/viz/sectorViz/Heal/HealSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/Heal/HealAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Heal/HealAgePieData.php", function(error, data) {
