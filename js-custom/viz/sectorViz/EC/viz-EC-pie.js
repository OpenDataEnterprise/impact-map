...
// d3.csv("js-custom/viz/sectorViz/EC/ECTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/EC/ECTypePieData.php", function(error, data) {
...
d3.json("js-custom/viz/sectorViz/EC/ECSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/EC/ECAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/EC/ECAgePieData.php", function(error, data) {
