...
// d3.csv("js-custom/viz/sectorViz/MC/MCTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/MC/MCTypePieData.php", function(error, data) {
...
d3.json("js-custom/viz/sectorViz/MC/MCSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/MC/MCAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/MC/MCAgePieData.php", function(error, data) {
