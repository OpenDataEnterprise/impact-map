...
// d3.csv("js-custom/viz/sectorViz/Consu/ConsuTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Consu/ConsuTypePieData.php", function(error, data) {
...
// d3.csv("js-custom/viz/sectorViz/Consu/SizeTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Consu/ConsuSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/Consu/ConsuAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Consu/ConsuAgePieData.php", function(error, data) {
