...
// d3.csv("js-custom/viz/sectorViz/ACT/ACTTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/ACT/ACTTypePieData.php", function(error, data) {
...
// d3.csv("js-custom/viz/sectorViz/ACT/SizeTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/ACT/ACTSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/ACT/ACTAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/ACT/ACTAgePieData.php", function(error, data) {
