...
// d3.csv("js-custom/viz/sectorViz/Gov/GovTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Gov/GovTypePieData.php", function(error, data) {
...
d3.json("js-custom/viz/sectorViz/Gov/GovSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/Gov/GovAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Gov/GovAgePieData.php", function(error, data) {
