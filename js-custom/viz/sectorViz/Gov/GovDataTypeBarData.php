...
// 14 Security and public safety
	$sql = "SELECT count(distinct(org_data_use.profile_id)) from org_data_use, org_profiles
		where org_data_use.profile_id = org_profiles.profile_id
		and industry_id = 'Governance'
		and data_type = 'Security and public safety'";
	...
	$num = $string1 + $string2;
	if ($num != 0) {$obj = new stdClass();
			$obj->app_type = "Security & Public Safety";
			$obj->number = $num;
			$data[] = $obj;}
