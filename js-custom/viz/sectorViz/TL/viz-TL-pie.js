...
// d3.csv("js-custom/viz/sectorViz/TL/TLTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/TL/TLTypePieData.php", function(error, data) {
...
// d3.csv("js-custom/viz/sectorViz/TL/SizeTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/TL/TLSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/TL/TLAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/TL/TLAgePieData.php", function(error, data) {
