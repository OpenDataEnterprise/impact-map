...
// d3.csv("js-custom/viz/sectorViz/IG/IGTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/IG/IGTypePieData.php", function(error, data) {
...
d3.json("js-custom/viz/sectorViz/IG/IGSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/IG/IGAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/IG/IGAgePieData.php", function(error, data) {
