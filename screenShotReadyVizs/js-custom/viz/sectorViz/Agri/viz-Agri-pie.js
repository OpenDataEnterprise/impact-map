...
// d3.csv("js-custom/viz/sectorViz/Agri/AgriTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Agri/AgriTypePieData.php", function(error, data) {
...
// d3.csv("js-custom/viz/sectorViz/Agri/SizeTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Agri/AgriSizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/Agri/AgriAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/Agri/AgriAgePieData.php", function(error, data) {
