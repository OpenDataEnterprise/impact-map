...
// d3.csv("js-custom/viz/sectorViz/HRE/HRETypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/HRE/HRETypePieData.php", function(error, data) {
...
// d3.csv("js-custom/viz/sectorViz/HRE/SizeTypePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/HRE/HRESizePieData.php", function(error, data) {
  if (error) throw error;
...
// d3.csv("js-custom/viz/sectorViz/HRE/HREAgePieData.php", type, function(error, data) {
d3.json("js-custom/viz/sectorViz/HRE/HREAgePieData.php", function(error, data) {
