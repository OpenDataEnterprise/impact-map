...
$app->get('/org_profiles', function($request, $response, $args){
	$db = new DBHandle();
	$all = $db->getorg_profiles();
...
$app->get('/data_uses', function($request, $response, $args){
	$db = new DBHandle();
	$all = $db->getdata_uses();
	return $response->withJson(formatOutput(true, $all, 'Request Succeeded'));
});
...
$app->get('/AllInRegion/{region}', function($request, $response, $args){
	...
	$db = new DBHandle();
	$all = $db->getall_in_region($region);
	return $response->withJson(formatOutput(true, $all, 'Request Succeeded'));
});

// Get complete profiles of all organizations in a sector.
$app->get('/AllInSector/{sector}', function($request, $response, $args){
	...
	$db = new DBHandle();
	$all = $db->getall_in_sector($sector);
	return $response->withJson(formatOutput(true, $all, 'Request Succeeded'));
});
