	...
	*/
	...
	var GridNoData = React.createClass({
	    ...
	    render: function () {
	        ...
	        return React.createElement("div", {className: 'no-data-display-container'},
						React.createElement("div", {className: 'no-results-text-container'},
							React.createElement("span", null, "No Results.")
						),
						React.createElement("div", {className: 'take-survey-text'},
							...
							React.createElement("a", {href: 'http://opendataenterprise.org/map/survey', target: '_black'}, "Take our survey.")
						),
						React.createElement("div", {className: 'suggest-survey-text'},
							...
							React.createElement("a", {href: 'mailto:map@odenterprise.org'}, "Send us an email.")
						)
			)
	    }
	});
