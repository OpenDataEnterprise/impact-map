...
class Validate {
	 ...
	 *    message otherwise.
	 */
	public static function xss ( $val, $data, $opts, $host ) {
		$cfg = Validate::_extend( $opts, null, array(
	 ...
	 *    message otherwise.
	 */
	public static function values( $val, $data, $opts, $host ) {
		$cfg = Validate::_extend( $opts, null, array(
			'empty'   => null,
	 ...
	 *    message otherwise.
	 */
	public static function noTags ( $val, $data, $opts, $host ) {
		$cfg = Validate::_extend( $opts, null, array(
	 ...
	 *    message otherwise.
	 */
	public static function dbValues( $val, $data, $opts, $host ) {
		$cfg = Validate::_extend( $opts, null, array(
			'empty'   => null,
			'message' => 'This value is not valid',
			'db'      => null,
