...
<html>
    <head>
        ...
        <link href="/survey/css3/bootstrap.css" rel="stylesheet" />
        <link href="/survey/dist/jquery.bootgrid.css" rel="stylesheet" />
        <script src="/survey/js3/modernizr-2.8.1.js"></script>
        <style>
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-md-10" style="border:0px solid blue;">
                    ...
                    <div style="margin:10% 30% 0 30%;height:600px;text-align:center;">
                        <h3><a href="/survey/start">Take survey</a></h3>
        ...
        <script src="/survey/lib/jquery-1.11.1.min.js"></script>
        <script src="/survey/js3/bootstrap.js"></script>
        <script src="/survey/dist/jquery.bootgrid.js"></script>
          <!-- geocomplete -->
