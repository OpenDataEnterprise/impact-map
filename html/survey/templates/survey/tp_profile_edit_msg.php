...
<div class="container lg-font col-md-12" style="border:0px solid black;">
    ...
    <div class="col-md-12" role="eligibility" id="role-eligibility">
      ...
      <div style="text-align:center;">
        ...
        <br />
          <a href="http://<?php echo $content['HTTP_HOST']; ?>/survey/edit/<?php echo $content['surveyId']; ?>/form">http://<?php echo $content['HTTP_HOST']; ?>/survey/edit/<?php echo $content['surveyId']; ?>/form</a>
      </div>
    </div>
