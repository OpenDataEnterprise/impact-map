...
// d3.csv("viz-data/data-sample-pie1.csv", type, function(error, data) {
  d3.json("js-custom/viz/regionViz/EAP/EAPTypePieData.php", function(error, data) {
...
d3.json("js-custom/viz/regionViz/EAP/EAPSizePieData.php", function(error, data) {
  if (error) throw error;
  // console.log(data);
  total = 0;
    for (i=0; i<data.length; i++) {
...
// d3.csv("viz-data/data-sample-pie3.csv", type, function(error, data) {
  d3.json("js-custom/viz/regionViz/EAP/EAPAgePieData.php", function(error, data) {
  if (error) throw error;
