  <div class="footer">
    ...
    <div class="footer-logos-container w-clearfix">
      <img class="footer-logo" src="/images/footer-open-data-enterprise-logo@2x.png" width="94">
      <img class="footer-logo idrc" src="/images/idrc-footer-logo@2x.jpg" width="78">
      <img class="footer-logo" src="/images/footer-open-data-logo@2x.png" width="101">
      <img class="cc footer-logo" src="/images/footer-creative-commons-logo@2x.png" width="78">
    </div>
  </div>
